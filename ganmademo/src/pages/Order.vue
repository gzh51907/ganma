  ...
  <div id="app">
    <div class="sub-all">
      ...
      <div class="store-item">
        ...
        <div class="goods clear">
          <p class="p fl">
            <img
              mode="widthFix"
              src="https://respic.wzq998.com//uploads/goods/20190726/886a39c87cc6361fc24daebc7cbc871f.jpg"
              class="img"
            />
          </p>
          <div class="info fl">
            <p class="price">
              ...
              <b class="b" style="color:red">9.90</b>
              <em class="em" style="font-style:normal">x1</em>
            </p>
            <p class="name">石头花生 230克/袋(230克/袋)</p>
            <p class="p1">230克/袋</p>
          </div>
      ...
      <div class="clear bt">
        <div class="fl one">
          合计：
          <i class="i" style="color:red">￥17.90</i>
        </div>
        <div class="fr two">提交订单</div>
      </div>
    </div>
  </div>
</template>
